...
class MainWindow(QMainWindow):
    ...
    def _setup_ui_interface(self) -> None:
        ...
        self.ui_adapter.set_message_callbacks(
            success_callback=self._show_success_message,
    ...
    def _connect_signals(self) -> None:
        ...
        # File selection
        self.cw.toolButton_input_file.clicked.connect(
            self.file_controller.select_input_file
        )
        self.cw.toolButton_output_file.clicked.connect(
            self.file_controller.select_output_file
        )
    ...
    def _setup_debug_mode(self) -> None:
        ...
        self.ui_adapter.set_input_file_path(
    ...
    def _start_conversion(self) -> None:
        ...
        try:
            ...
            self.current_worker.started.connect(
                lambda: self.ui_adapter.set_convert_button_enabled(False)
            )
