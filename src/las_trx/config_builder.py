...
class ConfigurationBuilder:
    ...
    def validate_configuration(self, config: TransformConfig) -> list[str]:
        ...
        if (config.origin.ref_frame == config.destination.ref_frame and
            config.origin.coord_type == config.destination.coord_type and
            config.origin.vd == config.destination.vd and
            config.origin.epoch == config.destination.epoch):
